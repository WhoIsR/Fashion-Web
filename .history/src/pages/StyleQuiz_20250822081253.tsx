      ...
      <div className="min-h-screen py-16">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-scale-in">
            <Sparkles size={48} className="text-purple-500 mx-auto mb-6" />
              ...
              <div className="text-left">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {styleProfile.recommendations.map((item, index) => (
                    <div
                      key={index}
                      className="bg-purple-50 rounded-lg p-3 text-center font-medium text-purple-800"
                    >
                      {item}
                    </div>
                  ))}
            ...
            <div className="space-y-4">
              ...
              <button
                onClick={resetQuiz}
                className="block mx-auto text-gray-600 hover:text-black transition-colors"
              >
                Retake Quiz
              </button>
            </div>
    ...
    <div className="min-h-screen py-16">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <Sparkles size={48} className="text-purple-500 mx-auto mb-6 animate-bounce-gentle" />
          <h1 className="text-4xl font-serif font-bold text-gray-900 mb-4">
            Discover Your Style
          </h1>
          ...
          <div className="space-y-4">
            {questions[currentQuestion].options.map((option, index) => (
              <button
                ...
                className={`w-full p-4 text-left rounded-xl border-2 transition-all duration-200 hover:border-purple-300 hover:bg-purple-50 ${
