...
const ProductDetail = () => {
  ...
  const handleFavorite = () => {
    toast.success('Added to wishlist (dummy)');
    navigate('/profile');
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button onClick={handleFavorite} aria-label="Add to wishlist" className="p-4 border border-gray-300 dark:border-dark-border rounded-lg hover:bg-gray-50 dark:hover:bg-dark-card transition-colors">
