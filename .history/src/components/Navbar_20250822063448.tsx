        ...
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="logo-container group">
            <div className="flex items-center space-x-1 transition-transform duration-300 group-hover:scale-105">
              <span className="logo-text text-brand-text dark:text-dark-text">AR</span>
              <div className="logo-middle relative">
                <span className="logo-v-top text-brand-text dark:text-dark-text">V</span>
                <div className="logo-dot bg-brand-purple-dark dark:bg-dark-primary"></div>
                <span className="logo-v-bottom text-brand-text dark:text-dark-text">V</span>
              </div>
              <span className="logo-text text-brand-text dark:text-dark-text">E</span>
            </div>
          </Link>
