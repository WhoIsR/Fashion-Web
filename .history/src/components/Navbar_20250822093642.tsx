  ...
  return (
    ...
    `}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="md:hidden flex items-center">
              <button
                ...
                className="p-2 rounded-md text-brand-text dark:text-dark-text hover:bg-gray-100 dark:hover:bg-dark-card transition-colors"
        ...
        {/* Mobile Menu */}
        <div
          className={`md:hidden overflow-hidden transform transition-all duration-300 ease-out ${
            isOpen ? 'max-h-[360px] opacity-100 translate-y-0' : 'max-h-0 opacity-0 -translate-y-2 pointer-events-none'
          }`}
          id="mobile-menu"
          aria-hidden={!isOpen}
        >
          <div className="px-3 pt-2 pb-3 space-y-1">
            {navigation.map((item) => (
              <Link
                ...
                className={`
                  relative block px-3 py-2 rounded-md text-base font-medium group
              ...
              >
                ...
                <span
                  className={`
                    ...
                    bg-brand-purple-dark/50 dark:bg-dark-primary/50
