      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white dark:bg-dark-card border border-gray-100 dark:border-dark-border rounded-xl p-6">
            ...
            <div className="flex items-center gap-3 p-4 border border-dashed border-gray-300 dark:border-dark-border rounded-lg text-gray-600 dark:text-gray-400">
              <Package size={18} />
              <div>
              ...
              <div className="ml-auto">
                <Link to="/catalog" className="btn-secondary">Shop Now</Link>
              </div>
            </div>
          </div>
